...
In order to work easily with VCLib, you can use the CMake configuration. The minimum required version is 3.24.
...
To include VCLib in your CMake project, first clone (recursively) the VCLib repository into your project directory. Then, in your `CMakeLists.txt`:
