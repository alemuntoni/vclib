...
All the prebuilt data structures are documented in the [meshes](../../../VCLib/group__meshes.md).
...
![trimesh](../../../images/trimesh.svg "TriMesh")
...
![trimesh vertex](../../../images/trimesh_vertex.svg "A Vertex Element")
...
To understand how these entities are organized and implemented, we suggest to take a look at the [Components](mesh/1_components.md), [Elements](mesh/2_elements.md) and [Containers](mesh/3_containers.md) pages.
...
![trimesh vertex components](../../../images/trimesh_vertex_components.svg "Vertex Components")
...
The Vertex container will then store both the Elements and the Vertical components (if they are optional, only the enabled ones) of the Elements. For example, assuming that we enable only the Adjacent Faces of the previous Vertex Element:
 ...
 ![vertex container](../../../images/vertex_container.svg "Vertex Container with Optional Components")
