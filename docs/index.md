...
The library is divided in several modules, and they can be found in the [vclib](https://github.com/cnr-isti-vclab/vclib/tree/main/vclib) directory inside the root of the repository. They are written in C++20, and can be built with CMake. The python side of the library is then generated using pybind11[https://pybind11.readthedocs.io/en/stable/].

Each module of the library has a specific purpose:
...
VCLib documentation is generated with [Doxygen](https://www.doxygen.nl/index.html) and [MkDocs](https://www.mkdocs.org/), using the [MkDoxy plugin](https://github.com/JakubAndrysek/MkDoxy) and the [Material for MkDocs](https://squidfunk.github.io/mkdocs-material/) theme.

To generate the documentation, you need to have python installed on your system, and run (from the root of the repository):
...
Or you can serve the documentation locally by running:
